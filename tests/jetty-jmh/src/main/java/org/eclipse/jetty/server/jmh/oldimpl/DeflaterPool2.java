...
package org.eclipse.jetty.server.jmh.oldimpl;

import java.util.zip.Deflater;

public class DeflaterPool2 extends CompressionPool2<Deflater>
{
     ...
     */
    public DeflaterPool2(int capacity, int compressionLevel, boolean nowrap)
    {
        super(capacity);
